...
export function Footer() {
  return (
    <footer className="bg-secondary border-t border-accent/20 text-foreground">
        ...
        <div className="py-12 lg:py-16 grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4">
              ...
              <a 
                href="https://www.instagram.com/abogadosfederico/" 
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-accent transition-colors"
              ...
              <a 
                href="https://www.tiktok.com/@abogadosfederico" 
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-accent transition-colors"
                aria-label="TikTok"
